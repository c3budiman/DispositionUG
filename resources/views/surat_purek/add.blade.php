...
@section('title')
  {{DB::table('setting_situses')->where('id','=','1')->first()->namaSitus}} | Tambah Surat Purek II
@endsection
...
@section('content')
  ...
  <div class="card-box">
    ...
    <div class="pull-right">
        <a  href="/purek_ii" class="btn btn-danger"><i class="fa fa-reply"></i> Cancel</a>
      ...
      <h4 class="header-title m-t-0">UG Disposisi: Menambah Surat Purek II Keluar</h4>
      <p class="text-muted font-14 m-b-10">
         Disini anda bisa menambah Surat Purek II Keluar
      </p>
          {{ csrf_field() }}
