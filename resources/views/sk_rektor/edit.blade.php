...
@section('content')
  ...
  <div class="card-box">
    <form enctype="multipart/form-data" action="/sk_rektor/edit" method="post" class="form-horizontal ">
    <div class="pull-right">
        <a  href="/sk_rektor" class="btn btn-danger"><i class="fa fa-reply"></i> Cancel</a>
    ...
    <h4 class="header-title m-t-0">Mengubah SK Rektor</h4>
    <p class="text-muted font-14 m-b-10">
       Mengubah sk rektor dengan nomor sk : {{$data->nomor_sk}}
    </p>
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-4">
                <input name="nomor" type="text" required class="form-control" value="{{$data->nomor_sk}}">
            </div>
