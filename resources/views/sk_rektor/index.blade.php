...
@section('title')
  {{DB::table('setting_situses')->where('id','=','1')->first()->namaSitus}} | SK Rektor
@endsection
          ...
          <div class="row">
              <div class="col-12">
                  <div class="card-box table-responsive">
                      <h4 class="m-t-0 header-title">Disposisi : SK Rektor</h4>
                      <p class="text-muted font-14 m-b-30">
                          Anda bisa menambah, mengedit dan menghapus sk rektor. fungsi pencarian berlaku untuk seluruh kolom.
                      </p>
                      <div class="pull-right" style="margin-top:-50px">
                          <a href="/sk_rektor/add" class="btn btn-xs btn-success"> <i class="fa fa-plus"></i> Tambah</a>
