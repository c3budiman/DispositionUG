...
@section('content')
  ...
  <div class="card-box">
    <form enctype="multipart/form-data" action="/surat_rektor/edit" method="post" class="form-horizontal ">
    <div class="pull-right">
        <a  href="/surat_rektor" class="btn btn-danger"><i class="fa fa-reply"></i> Cancel</a>
    ...
    <h4 class="header-title m-t-0">Mengubah Surat Rektor Keluar</h4>
    <p class="text-muted font-14 m-b-10">
       Mengubah surat Rektor Keluar untuk nomor surat : {{$data->nomor}}
    </p>
        {{ csrf_field() }}
        <input type="hidden" name="id" value="{{$data->id}}">
        <div class="form-group row">
            <label class="col-2 col-form-label">Nomor Surat : </label>
            <div class="col-4">
                <input name="nomor" type="text" required class="form-control" value="{{$data->nomor}}">
            </div>
        ...
        <div class="form-group row">
            <label class="col-2 col-form-label">Tujuan Surat : </label>
            <div class="col-4">
              <input name="tujuan" type="text" required class="form-control" value="{{$data->tujuan}}">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-9">
              <input name="perihal" type="text" required class="form-control" value="{{$data->perihal}}">
            </div>
        </div>
        <div class="form-group row">
