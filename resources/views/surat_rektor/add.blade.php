...
@section('title')
  {{DB::table('setting_situses')->where('id','=','1')->first()->namaSitus}} | Tambah Surat Rektor
@endsection
...
@section('content')
  ...
  <div class="card-box">
    <form enctype="multipart/form-data" action="{{url(action("AdminController@postSuratRektorAdd"))}}" method="post" class="form-horizontal ">
    <div class="pull-right">
      ...
      <h4 class="header-title m-t-0">Menambah Surat Rektor Keluar</h4>
      <p class="text-muted font-14 m-b-10">
         Disini anda bisa menambah surat keluar untuk Rektor
      </p>
          {{ csrf_field() }}
          <div class="form-group row">
              ...
              <div class="col-4">
                ...
                $count_db = DB::table('surat_rektors')->count() + 1;
                $bulan = date('m');
                $bulan_romawi = numberToRomanRepresentation($bulan);
                $tahun = date('y');
                $num_padded = sprintf("%02d", $count_db);
                $nomor_surat = $num_padded."/WAREK/UG/".$bulan_romawi."/".$tahun;
                 ?>
